...
public class TestDataFactory {
    ...
    public static Drug createTestDrug() {

        return new Drug("Paracetamol", 500.0f, LocalDate.of(2023, 11, 1), LocalDate.of(2023, 11, 10));
    }

    public static Patient createMultipleTestPatients(int ID, String NAME){
        // BASIC ATTRIBUTES
        int id = ID;
